...
80100b40:	e8 3b 20 00 00       	call   80102b80 <end_op>
  if((stack2 = allocuvm(pgdir, stack2, stack2 + 2) == 0))	//NEW: KERNBASE2 and PGSIZE
...
//  struct proc *curproc = myproc();
  ...
  if(addr >= KERNBASE2 || addr+4 > KERNBASE2)	//NEW: KERNBASE2
...
801044f3:	8b 55 08             	mov    0x8(%ebp),%edx
  ...
  if(addr >= KERNBASE2)	//NEW: KERNBASE2
...
80104503:	89 11                	mov    %edx,(%ecx)
  ep = (char*)KERNBASE2;	//Do we chane this?
  for(s = *pp; s < ep; s++){
    if(*s == 0)
...
8010458e:	78 20                	js     801045b0 <argptr+0x40>
    return -1;
  if(size < 0 || (uint)i >= KERNBASE2 || (uint)i+size > KERNBASE2)	//NEW: KERNBASE2
...
80105658:	8b 40 7c             	mov    0x7c(%eax),%eax
...
80105672:	8b 40 7c             	mov    0x7c(%eax),%eax
...
80105685:	8b 40 7c             	mov    0x7c(%eax),%eax
...
801056b8:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
...
801056c1:	8b 40 7c             	mov    0x7c(%eax),%eax
...
801057d5:	8b 40 7c             	mov    0x7c(%eax),%eax
...
8010667e:	0f 84 cd 00 00 00    	je     80106751 <switchuvm+0xe1>
  if(p->kstack == 0)
80106684:	8b 46 08             	mov    0x8(%esi),%eax
...
8010671d:	8b 56 08             	mov    0x8(%esi),%edx
...
80106c1e:	5d                   	pop    %ebp
80106c1f:	c3                   	ret    
  for(j = KERNBASE2 - PGSIZE + 1; szStack > 0; j -= PGSIZE, szStack--) {
